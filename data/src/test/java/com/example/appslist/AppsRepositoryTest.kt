import com.example.appslist.testLogger.TestLogger
...
class AppsRepositoryImplementTest {
    private val listAppsApi: ListAppsApi = mock()
    private val appInfoDao: AppInfoDao = mock()

    private val appsRepository = AppsRepositoryImplement(listAppsApi, appInfoDao)
